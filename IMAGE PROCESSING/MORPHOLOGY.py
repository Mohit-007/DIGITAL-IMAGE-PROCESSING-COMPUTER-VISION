# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 11:26:53 2019
...
#    k = cv2.getStructuringElement(cv2.MORPH_ELLIPSE,(5, 5))
    ...
    erosion = cv2.erode(binary_inv, k, iterations = 1)  # it erode the border and mix it with (black in white)
    
    dilation = cv2.dilate(binary_inv, k, iterations = 1) # it will dilate and the border of white will expand
    
    gradient = cv2.morphologyEx(binary_inv, cv2.MORPH_GRADIENT, k) # it will gradient the boundary of black and white
